            ...
            <li class="nav-parent nav-active">
              ...
              <ul class="children">
                ...
                if (file_exists('/srv/rutorrent/plugins/diskspaceh/plugin.info')) {
                  echo "<a href=\"?removeplugin-diskspaceh=true\">diskspace<span style=\"color:green;font-weight:bold\">H</span> <span class=\"tooltips text-inverted fa fa-question-circle\" data-toggle=\"tooltip\" title=\"This plugin adds an easy to read disk meter to the bottom bar for /home mounted installs.\" data-placement=\"right\"></span> <span class=\"pull-right plgin-center-switch\"><img src=\"img/switch-installed.png\"></span></a>";
                } else {
                  echo "<a href=\"?installplugin-diskspaceh=true\">diskspace<span style=\"color:green;font-weight:bold\">H</span> <span class=\"tooltips text-inverted fa fa-question-circle\" data-toggle=\"tooltip\" title=\"This plugin adds an easy to read disk meter to the bottom bar for /home mounted installs.\" data-placement=\"right\"></span> <span class=\"pull-right plgin-center-switch\"><img src=\"img/switch-notinstalled.png\"></span></a>";
                }
                echo "</li>";
